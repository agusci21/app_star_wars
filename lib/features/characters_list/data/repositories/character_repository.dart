...
class CharacterRepository implements ICharacterRepository {
  ...
  Future<GetCharactersOutput> getCharacters(GetCharactersInput input) async {
    ...
    try {
      ...
      final rawCharacters = (data['results']) as List;
      ...
      return GetCharactersOutput.withData(
          characters: characters, hasNextPage: data['next'] != null);
      // final response = await _httpHelper.get(url);
      // if(response.isOk){
      //   final rawCharacters = (response.data['results' ]) as List;
      //   final List<Character> characters = List.generate(rawCharacters.length , (index) => Character.fromJson(rawCharacters[index]));
      //   return GetCharactersOutput.withData(characters: characters, hasNextPage: response.data['next'] != null);
      // }
